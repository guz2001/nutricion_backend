...
#TRADUCCION:esto viene apagado por defecto porque detecté una tabla existente — bórralo solo si quieres que Django la administre
#Sale este mensaje por que detecto que ya hay una tabla existente
